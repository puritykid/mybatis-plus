package com.example.mybatisplus.result;
...
public class Result {
    ...
    // 响应业务状态
    @ApiModelProperty(value = "状态码",name = "status",dataType = "Int",example = "2xx",required = true)
    private Integer status;

    // 响应消息
    @ApiModelProperty(value = "状态信息",name = "msg",dataType = "String",example = "xxx",required = true)
    private String msg;

    // 响应中的数据
    @ApiModelProperty(value = "响应数据",name = "data",dataType = "Object",example = "xxx",required = true)
    private Object data;
